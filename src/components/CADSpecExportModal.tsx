...
2. 齿轮副参数与中心距校验:
   ...
   - 齿轮副 1 (齿圈外齿 -> 副轴受动齿轮):
     ...
     * 副轴齿轮 z_c1 = 60, 分度圆 d_c1 = 105.00 mm (齿宽 22.0 mm)
     * 中心距 a1 = (105.00 + 105.00) / 2 = 105.00 mm (速比 i_r_c = 60/60 = 1.000)
...
3. 行星排机构参数:
   - 模数 m = 1.50 mm
   - 太阳轮: z_s = 18 (d = 27.00 mm)
   - 行星轮 (3个均布): z_p = 18 (d = 27.00 mm, 销轴分布圆直径 D = 54.00 mm)
   - 齿圈内齿: z_ri = 54 (d = 81.00 mm, 齿宽 22.0 mm)
   - 装配整数条件: (18 + 54) / 3 = 24 (成立)
   - 特性分流比 ρ = 54 / 18 = 3.000
